...
from utils.uat import UAT
method_config = { "num_generate": 8,
        "num_steps": 100,
        "num_optim_tokens": 10,
        }
...
class Detector(AbstractDetector):
    ...
    def inference_on_example_data(
        ...
        method = UAT()
        # target = "The area is a suburb of Metropolitan Detroit"
        # target = "Enlarge to view labels"
        # target = "For the 1936 song see Bojangles of Harlem"
        start = None
        print("predicting for index",target)
        predictions, scores = method.predict([target], tokenizer, model, verbose=True, **method_config ,start = start)
